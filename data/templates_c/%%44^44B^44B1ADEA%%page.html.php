<?php /* Smarty version 2.6.18, created on 2009-08-25 02:54:16
         compiled from admin/page.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'page', 'admin/page.html', 9, false),)), $this); ?>
<div class="PageList">
    <?php if ($this->_tpl_vars['page'] > 1): ?>
        <a class="other" href="<?php echo $this->_tpl_vars['domain']; ?>
<?php echo $this->_tpl_vars['common_url']; ?>
...
<?php echo $this->_tpl_vars['common_url']; ?>
<?php echo $this->_tpl_vars['p']; ?>
.html" ><?php echo $this->_tpl_vars['p']; ?>
</a>
         <?php endif; ?>
...
.html" ><?php echo $this->_tpl_vars['totalPage']; ?>
</a>             
    <?php endif; ?>
