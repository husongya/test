...
abstract class Yummy_Cache_Manager {
     ...
     */
    public static function getCache($id=MODULE_NAME){
     ...
     * @return Doggy_Cache_Provider
     */
    public static function set($key,$value,$group=MODULE_NAME,$ttl=null){
     ...
     * @return mixed
     */
    public static function get($key,$group=MODULE_NAME){
     ...
     * @return Doggy_Cache_Provider
     */
    public static function clear($group=MODULE_NAME){
     ...
     * @return Doggy_Cache_Provider
     */
    public static function remove($key,$group=MODULE_NAME){
