 ...
 * 
 * original code from Ma Bingyao <andot@ujn.edu.cn>
 */
abstract class Yummy_Util_XXTEA {
    ...
    /**
     * Encrypt data with key use XXTEA arithmetic
     * 
     * @param string $str
     * @param string $key
     * @return string
    ...
    /**
     * Decrypt data with key use XXTEA arithmetic
     * 
     * @param string $str
     * @param string $key
     * @return string
